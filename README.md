...
- **🪐 AstroEye event workspace:** Enter a verified local time, IANA time zone, and venue; save a reproducible chart; inspect its zodiac, houses, bodies, and aspects on an interactive wheel; and fly the globe to the event marker.
